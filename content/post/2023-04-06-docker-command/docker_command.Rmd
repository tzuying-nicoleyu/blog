...
---
Notes:
This is the note about how to use command line to restore .bak file in your local computer to docker.
...
So the command in general form should look like:
When you search for *docker cp*, you will find the bellow command from the official document. \n
```{bash}
...
![Figure 1: Docker's Conatainer page > green one is the container that is currently running ](docker_container.png)
